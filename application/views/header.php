...
<html>
<head>
	<!--- Internet Explorer Jumps to compatibility which shows errors !-->
	<meta http-equiv="X-UA-Compatible" content="IE=Edge"/>
	<!----  JS/ CSS all scripts go here.. -->	
	<link rel="stylesheet" href="<?php echo base_url();?>assets/font/stylesheet.css" type="text/css" charset="utf-8">
